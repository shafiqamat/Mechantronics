...
class task_user:
    ...
    def __init__(self, setpoint, gainP, gainI, speed, line, leftMotorGo, rightMotorGo,
                 ...
                 startTime=None):
        '''
        leftDataValues/leftTimeValues: position (not effort) and time for left motor.
        rightDataValues/rightTimeValues: same for right motor.
        startTime (Share): set to ticks_us() when starting collection so times are
        from one reference and stay non-negative.
        '''
        self._state = S0_MM
