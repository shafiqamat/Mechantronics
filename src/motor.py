...
class Motor:
    ...
    def __init__(self, PWM, DIR, nSLP, timernumber, channelnumber):
        '''Initializes a Motor object on the given pins and timer number.
        
        Args:
            PWM (Pin): The pin to use for the PWM signal.
            DIR (Pin): The pin to use for the direction signal.
            nSLP (Pin): The pin to use for the sleep signal.
            timernumber (int): The timer number to use for the PWM signal.
            channelnumber (int): The channel number to use for the PWM signal.
        '''
    ...
    def set_effort(self, effort):
        '''Sets the effort requested from the motor based on an input value
           between -100 and 100.

            :param effort: The effort requested from the motor.
            :type effort: int
            :returns: None
        '''
        if effort > 100:
