...
class sensor():
    ...
    def __init__(self,pin1,pin2,pin3,pin4,pin5):
        '''
        Initializes the sensor class, and sets the pins for the sensors.

        :param: pin1 (The pin for the leftmost sensor)
        :param: pin2 (The pin for the left sensor)
        :param: pin3 (The pin for the center sensor)
        :param: pin4 (The pin for the right sensor)
        :param: pin5 (The pin for the rightmost sensor)
        '''
    ...
    def get_pos(self):
        ...
        :param: None
        :returns: pos (The current position of the line sensor)
        :return type: float
        :notes: float returned - the position of the line sensor, where zero position
        is equivilient to centered,
